...
public class SelectGoods2Dao {
	public ArrayList<Goods> selectproduct(String kind_name){
		
	String sql="select k.kind_name,g.* from goods g,kind k where g.kind_id=k.kind_id and k.kind_id=(select kind_id from kind where kind_name=?)";
	ArrayList<HashMap<String,Object>> list=new ArrayList<HashMap<String,Object>>();
	list=JDBC.excutequery(sql,new Object[]{kind_name});
